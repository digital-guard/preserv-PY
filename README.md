...
A Paraguay se le asignó: en el contexto ISO 3166‑2 el geocódigo **PY** y el número **600**; en Wikidata el identificador [Q733](http://wikidata.org/entity/Q733); en OpenStreetMap el identificador de [*relación* 287077](http://osm.org/relation/287077).
